...
<header class="flex items-center justify-between p-4 bg-white shadow-md">
    ...
    <nav>
        <ul class="flex space-x-6 list-none">
            ...
            <li><a href="impacteSocial.php" class="text-gray-800 hover:text-blue-600 font-semibold">Impacte Social</a></li>
            ...
            <li><a href="quienes_somos.php" class="text-gray-800 hover:text-blue-600 font-semibold">¿Quiénes Somos?</a></li>
        </ul>
    </nav>
</header>
