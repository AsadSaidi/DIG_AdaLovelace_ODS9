  ...
  <main class="max-w-5xl mx-auto p-6 space-y-16">
    ...
    <section class="bg-orange-100 p-8 rounded-lg shadow-md hover-scale">
      ...
      <div class="space-y-4">
        ...
        <p><strong>Impacte:</strong> Millora l’accés a mercats, serveis de salut i educació en comunitats marginades, promovent la inclusió i reduint les desigualtats.</p>
        <p><strong>Exemple:</strong> Projectes com els de l’ONG Bridges to Prosperity, que construeix ponts peatonals en zones remotes.</p>
      </div>
    </section>
    <!-- Solució 2 -->
    <section class="bg-orange-100 p-8 rounded-lg shadow-md hover-scale">
      ...
      <div class="space-y-4">
        ...
        <p><strong>Impacte:</strong> Redueix l’empremta de carboni de la indústria, alineant-se amb la sostenibilitat i atraient inversions verdes.</p>
        <p><strong>Exemple:</strong> Empreses com SSAB a Suècia estan desenvolupant acer lliure de combustibles fòssils.</p>
      </div>
    </section>
    <!-- Solució 3 -->
    <section class="bg-orange-100 p-8 rounded-lg shadow-md hover-scale">
      ...
      <div class="space-y-4">
        ...
        <p><strong>Impacte:</strong> Augmenta l’eficiència, redueix costos operatius i millora la competitivitat de la indústria, especialment en països en desenvolupament, alhora que fomenta la creació de llocs de treball especialitzats en manteniment i programació d’aquestes tecnologies.</p>
        <p><strong>Exemple:</strong> Projectes com els d’Universal Robots, que ofereix braços robòtics col·laboratius (cobots) assequibles per a pimes, o la iniciativa Indústria 4.0 d’Alemanya, que integra tecnologies digitals a la manufactura.</p>
      </div>
    </section>
  </main>
